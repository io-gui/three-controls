...
const handleGeometry$1 = {
	...
	Y_xp: new HelperGeometry( edgeHandle, { color: [ 1, 0.5, 0.5 ], rotation: [ HPI$1, PI, 0 ] } ),
	...
	Z_xp_yp: new HelperGeometry( cornerHandle, { color: [ 1, 1, 0.5 ], rotation: [ PI, 0, HPI$1 ] } ),
	Z_xn_yn: new HelperGeometry( cornerHandle, { color: [ 1, 1, 0.5 ], rotation: [ PI, 0, - HPI$1 ] } ),
...
const pickerGeometry$1 = {
	...
	Y_xp: new HelperGeometry( edgePicker, { color: [ 1, 0.5, 0.5 ], rotation: [ HPI$1, PI, 0 ] } ),
	...
	Z_xp_yp: new HelperGeometry( cornerPicker, { color: [ 1, 1, 0.5 ], rotation: [ PI, 0, HPI$1 ] } ),
	Z_xn_yn: new HelperGeometry( cornerPicker, { color: [ 1, 1, 0.5 ], rotation: [ PI, 0, - HPI$1 ] } ),
