import { Mesh, Vector3, BoxBufferGeometry, Raycaster, Quaternion, Plane, UniformsUtils, Color, FrontSide, ShaderMaterial, DataTexture, RGBAFormat, FloatType, NearestFilter, Vector2, BufferGeometry, BufferAttribute, Euler, Matrix4, Float32BufferAttribute, Uint16BufferAttribute, CylinderBufferGeometry, OctahedronBufferGeometry, Box3 } from '../../lib/three.module.js';
...
class LineGeometry extends HelperGeometry {
...
const cornerHandle = new HelperGeometry( [
	[ new Corner2Geometry(), { rotation: [ - HPI$1, 0, 0 ], depthBias: 1 } ],
