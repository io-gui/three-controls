...
const guideGeometry = {
	X: new HelperGeometry( translateGuideGeometry, { color: colors[ 'red' ], opacity: 0.5, rotation: [ 0, 0, - HPI$1 ], depthBias: - 5 } ),
	Y: new HelperGeometry( translateGuideGeometry, { color: colors[ 'green' ], opacity: 0.5, depthBias: - 5 } ),
	Z: new HelperGeometry( translateGuideGeometry, { color: colors[ 'blue' ], opacity: 0.5, rotation: [ HPI$1, 0, 0 ], depthBias: - 5 } ),
};
