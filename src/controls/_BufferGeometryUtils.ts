...
export const BufferGeometryUtils = {
	...
	computeTangents: function ( geometry: BufferGeometry ) {
		...
		const tangents = attributes.tangent.array as Array<number>;
	...
	*/
	mergeBufferGeometries: function ( geometries: BufferGeometry[], useGroups?: boolean, mergedGeometry?: BufferGeometry ) {
	...
	*/
	mergeBufferAttributes: function ( attributes: BufferAttribute[] ): BufferAttribute | null {
		...
		for ( let i = 0; i < attributes.length; ++ i ) {
			...
			const attribute = attributes[ i ] as any;
